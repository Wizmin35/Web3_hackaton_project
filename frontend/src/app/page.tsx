  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 hero-bg overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-20 left-10 w-72 h-72 bg-pink-300 rounded-full blur-3xl opacity-50 animate-float" />
        <div className="absolute bottom-10 right-10 w-96 h-96 bg-rose-300 rounded-full blur-3xl opacity-50 animate-float" style={{ animationDelay: '2s' }} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-pink-50 text-pink-600 font-medium text-sm mb-6">
            ...
            <motion.p
              ...
              className="text-xl text-neutral-800 mb-10 max-w-2xl mx-auto"
            >
            ...
            >
              <div className="text-center">
                ...
                <div className="text-sm text-neutral-600">Salona</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-neutral-900">1000+</div>
                <div className="text-sm text-neutral-600">Rezervacija</div>
              </div>
              <div className="text-center">
      ...
      {/* Services Section */}
      <section className="py-20 lg:py-32 bg-pink-50/30 overflow-visible">
              ...
              return (
                ...
                >
                  <Link href={`/services/${service.id}`}>
                    <div className="card service-card group cursor-pointer h-full relative">
                      {service.popular && (
                        <span className="absolute -top-2 -right-2 px-3.5 py-1.5 bg-gradient-to-r from-pink-500 to-rose-500 text-white text-xs font-bold rounded-full z-30 shadow-xl whitespace-nowrap border-2 border-white">
                          Popularno
                        </span>
                      )}
      ...
      <section className="py-20 lg:py-32 bg-pink-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="card overflow-hidden">
                <div className="bg-gradient-to-r from-pink-500 to-rose-500 -mx-6 -mt-6 px-6 py-4 mb-6">
      ...
      {/* CTA Section */}
      <section className="py-20 lg:py-32 bg-gradient-to-br from-pink-600 to-rose-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          >
            ...
            {connected ? (
              <Link href="/services" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-pink-600 font-semibold rounded-xl hover:bg-white/90 transition-all text-lg">
                Započni rezervaciju
                <ArrowRight className="w-5 h-5" />
              </Link>
            ) : (
